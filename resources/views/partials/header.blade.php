<div class="top-header">
  <div class="container">
    <div class="top-header-left">
      <div class="inner-header-left"><p><a href="careers.html">JBlackMotionDesign, Votre compagne dans le domaine digital!</a> </p></div>
    </div>
...
<header>
  <div class="container">
    ...
    <div class="top-location">
      <div class="address">
        <figure class="address-icon"><img src="{{ asset('Frontend/img/master/address.png')}}" alt=""></figure>
        <h6>Localisation:</h6>
        <p>Agoè-assiyéyé</p>
      </div>
      <div class="email">
